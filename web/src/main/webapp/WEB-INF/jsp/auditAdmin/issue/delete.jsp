...
<jsp:root xmlns:jsp="http://java.sun.com/JSP/Page"
    ...
    <form action="issueAdmin/delete.do?readOnly=false">
        <input type="hidden" id="issueId" name="issueId" value="${entity.id}" />
        <input type="hidden" id="submit" title="OK" />
    </form>

    <table class="nonDataTable">
        <tr>
            <td class="ats-h1"><fmt:message key="issue.title"/></td>
    ...
    <h1 class="ats-warning">
        <fmt:message key="delete.issue.confirm.message"/>
    </h1>
